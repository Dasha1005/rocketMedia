...
$(function(){
	$('.tabs-controll button').click(function () {
		var owl = $('.slider-1.owl-carousel');
			owl.owlCarousel();
...
$('.tabs-controll button').click(function () {
	console.log('click');
	$(this).parent('.tabs-controll').find('button').removeClass('active');
	$(this).addClass('active');

	var tab_to_show = $(this);
	var tabs = $(this).parent('.tabs-controll').parent('.tabs-wrapper').children('.tab-content');

	tabs.each(function () {
		if ($(this).attr('data-tab') == $(tab_to_show).attr('data-tab')) {
			$(this).addClass('active');
		} else {
